...
export class UsersController {
  ...
  @ApiResponse({ status: 201, description: 'User has been successfully created.', type: CreateUserDto })
  ...
  @ApiParam({ name: 'id', description: 'User ID' })
  @ApiResponse({ status: 200, description: 'User has been successfully updated.', type: CreateUserDto })
  @ApiResponse({ status: 404, description: 'User not found.' })
